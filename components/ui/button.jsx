...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-800",
  {
    variants: {
      variant: {
        default: "bg-primary text-slate-50 hover:bg-slate-900/90 dark:bg-primary dark:text-slate-50 dark:hover:bg-white-900/30",
        destructive:
        ...
        secondary:
          "bg-transparent text-slate-900 hover:bg-slate-100/80 dark:bg-transparent dark:text-slate-50 dark:hover:bg-zinc-800/80",
        ghost: "hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-slate-800 dark:hover:text-slate-50/10",
