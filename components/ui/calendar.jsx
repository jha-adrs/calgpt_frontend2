  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-primary dark:text-slate-100 dark:hover:bg-slate-700 dark:hover:text-slate-100 dark:focus:bg-slate-50 dark:focus:text-slate-900",
